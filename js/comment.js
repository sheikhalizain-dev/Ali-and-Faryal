...
export const comment = (() => {
    ...
    const send = async (button) => {
        ...
        if (!id) {
            ...
            const length = document.getElementById('').children.length;
            ...
            document.getElementById('').innerHTML = card.renderContent(response.data) + document.getElementById('').innerHTML;
            scroll();
        }
    ...
    const scroll = () => document.getElementById('').scrollIntoView({ behavior: 'smooth' });
